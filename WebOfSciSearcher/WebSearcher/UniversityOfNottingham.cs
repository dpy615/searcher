...
namespace WebSearcher {
    public class UniversityOfNottingham : Searcher {
        ...
        public override void GetRes(object o) {
            ...
            for (int i = start; i < end; i++) {
                ...
                try {
                    ...
                    string uri = "http://eprints.nottingham.ac.uk/cgi/search/simple_m?q="+title+"&_action_search=Search&_order=bytitle&basic_srchtype=ALL&_satisfyall=ALL";
