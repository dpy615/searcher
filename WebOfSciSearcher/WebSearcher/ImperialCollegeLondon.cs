...
namespace WebSearcher {
    public class ImperialCollegeLondon : Searcher {
        ...
        public override void GetRes(object o) {
            ...
            for (int i = start; i < end; i++) {
                ...
                try {
                    ...
                    string uri = "https://spiral.imperial.ac.uk/simple-search?filtername=composite&filtertype=equals&filterquery=" + title + "&query=";
