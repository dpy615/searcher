...
namespace WebSearcher {
    public class UniversityOfKent : Searcher {
        ...
        public override void GetRes(object o) {
            ...
            for (int i = start; i < end; i++) {
                ...
                try {
                    ...
                    string uri = "https://kar.kent.ac.uk/cgi/search/simple?q="+title+"&_action_search=&_action_search=Search&_order=bytitle&basic_srchtype=ALL&_satisfyall=ALL";
