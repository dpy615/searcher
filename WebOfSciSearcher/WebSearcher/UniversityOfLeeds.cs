...
namespace WebSearcher {
    public class UniversityOfLeeds : Searcher {
        ...
        public override void GetRes(object o) {
            ...
            for (int i = start; i < end; i++) {
                ...
                try {
                    ...
                    string uri = "http://eprints.whiterose.ac.uk/cgi/search/simple?full="+title+"&_action_search=Search&_order=bytitle&basic_srchtype=ALL&_satisfyall=ALL";
