...
namespace WebSearcher {
    public class UniversityOfExeter : Searcher {
        ...
        public override void GetRes(object o) {
            ...
            for (int i = start; i < end; i++) {
                ...
                try {
                    ...
                    string uri = "https://ore.exeter.ac.uk/repository/discover?query=" + title + "&submit=";
                    ...
                    res = DealStr(res);
                    if (res.ToLower().Contains(("<h4>"+title_old).ToLower())) {
                        dt.Rows[i]["isIn"] = "YES";
                        yes++;
                    } else {
                        dt.Rows[i]["isIn"] = "NO";
