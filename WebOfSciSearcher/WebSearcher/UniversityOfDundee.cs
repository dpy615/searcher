...
namespace WebSearcher {
    public class UniversityOfDundee : Searcher {
        ...
        public override void GetRes(object o) {
            ...
            for (int i = start; i < end; i++) {
                ...
                try {
                    ...
                    string uri = "http://discovery.dundee.ac.uk/portal/en/searchall.html?searchall=" + title;
        ...
        private string DealStr(string str_o) {
            string str = str_o;
            str = str.Replace("\r", "").Replace("\n", "").Replace("<span>", "").Replace("</span>", "").Replace("<span class=\"highlight\">", "").Replace("<sub>", "").Replace("</sub>", "").Replace("<em>", "").Replace("</em>", "");
            return str;
        }
    }
}
