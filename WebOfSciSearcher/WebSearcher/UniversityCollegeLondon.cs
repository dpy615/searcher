...
namespace WebSearcher {
    public class UniversityCollegeLondon : Searcher {
        ...
        public override void GetRes(object o) {
            ...
            for (int i = start; i < end; i++) {
                ...
                try {
                    ...
                    string uri = "http://search2.ucl.ac.uk/s/search.html?query="+title+"&collection=ucl-discovery";
        ...
        private string DealStr(string str_o) {
            string str = str_o.ToLower();
            str = str.Replace("<strong>", "").Replace("</strong>", "").Replace(".","");
